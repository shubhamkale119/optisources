      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
            ...
            <span className="block text-secondary-light">Revenue Management</span>
          </h1>
          
          <p className="text-xl md:text-2xl text-white/90 mb-8 leading-relaxed">
            Empowering healthcare organizations with AI-powered solutions for revenue cycle optimization, 
            medical coding excellence, and compliance management.
          </p>
